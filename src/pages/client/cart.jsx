        ...
        <div className="w-full h-full flex justify-center p-[40px]">
            <div className="w-[700px]">
                        ...
                        return(
                            <div key={index} className="w-full h-[100px] bg-white shadow-2xl my-[5px] flex justify-between items-center relative">
                                ...
                                <div className="h-full w-[100px] flex justify-center items-center">
                                    <button className="text-2xl w-[30px] h-[30px] bg-black text-white rounded-full flex justify-center items-center curso-pointer mx-[5px]"
                                    onClick={()=>{
                                        addToCart(item, -1)
                                        setCartLoaded(false)
                                    }}>-</button>
                ...
                <div className="w-full flex justify-end mt-4">
                    <button className="w-[170px] text-xl text-center shadow bg-pink-400 text-white h-[40px] rounded-lg cursor-pointer" onClick={() =>{
                        navigate("/checkout" ,
                            {
                                state: {
                                    items : cart
