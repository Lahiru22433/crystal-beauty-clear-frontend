        ...
        }
        {
            status == "loaded" && 
               <div className="w-full h-full flex flex-col lg:flex-row">
                   <h1 className="text-3xl lg:hidden font-bold text-center mb-[40px]">{product.name}{" | "}<span className="text-3xl mr-[20px] text-gray-500">{product.altNames.join(" | ")}</span></h1>
                   ...
                   <div className="w-full pt-[100px] h-full p-[40px]">
                        ...
                        <div className="w-full flex justify-center mb-[40px]">
                            <button className="bg-pink-800 border border-pink-800 text-white hover:bg-white w-[200px] h-[50px] hover:text-pink-800 cursor-pointer py-2 px-4 rounded-lg" onClick= {
                                ()=>{
                                    addToCart(product, 1)
