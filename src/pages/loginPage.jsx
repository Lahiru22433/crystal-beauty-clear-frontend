        ...
        <div className = "w-full h-screen bg-[url(/login-bg.jpg)]  bg-cover bg-center flex">
            ...
            <div className="w-[50%] h-full flex justify-center items-center">
                <div className="w-[450px] h-[600px] backdrop-blur-xl shadow-xl rounded-xl flex flex-col justify-center items-center" >
                    ...
                    <button onClick={handleLogin} className="w-[400px] h-[50px] bg-green-500 text-white rounded-xl m-[5px] cursor-pointer">
                        {
                            loading?"Loading...":"Login"
                        }
                    </button>
                    <button className="w-[400px] h-[50px] bg-green-500 mt-[20px] text-white rounded-xl m-[5px] cursor-pointer flex justify-center items-center"
