                        ...
                        <div className="fixed bg-[#00000070] w-full h-full top-0 left-0 flex justify-center items-center">
                            <div className="w-[600px] max-w-[600px] h-[600px] max-h-[600px] bg-white relative">
                                <div className="w-full h-[150px]">
                                    ...
                                    <h1 className="text-sm font-bold p-2">Date: {new Date(displayingOrder.date).toDateString()}</h1>
                                    <h1 className="text-sm font-bold p-2">Order Status: {displayingOrder.ststus}</h1>
                                    <h1 className="text-sm font-bold p-2">Oredr Total: {displayingOrder.total.toFixed(2)}</h1>
                                </div>
                                <div className="w-full h-[450px] max-h-[450px] overflow-y-scroll">
                                {
                                    displayingOrder.billItems.map((item, index) =>{
                                        return(
                                            <div key={index} className="w-full h-[100px] bg-white shadow-2xl my-[5px] flex justify-center items-center p-2 relative">
                                ...
                                <button className="w-[30px] absolute right-[-20px] top-[-20px] h-[30px] rounded-full bg-white shadow shadow-black flex justify-center items-center cursor-pointer" 
                                onClick={()=>{
